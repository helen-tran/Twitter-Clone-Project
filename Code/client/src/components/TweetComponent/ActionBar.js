...
const ActionBar = ({ isLiked, numLikes, numRetweets }) => {
  ...
  const styleIconLike = {
    color: "#657786",
    fill: like ? "#EA3D3D" : "transparent",
    stroke: like ? "none" : "#657786",
  };
  return (
    <Wrapper>
      <Content>
        <ButtonDiv>
          <ActionButton>
            <FiMessageCircle style={styleIcon} />
          </ActionButton>
        </ButtonDiv>
        ...
        <ButtonDiv>
          ...
          <Action>
            <ActionButton onClick={handleToggleLike}>
              <FiHeart style={styleIconLike} />
